...
model.summary()
flops = get_flops(awesome_3D_CNN(depth=D, width=W, height=H), batch_size=1)
...
#     "./checkpoints/3dcnn_40.h5", save_best_only=True
# )
...
# model.load_weights("./checkpoints/3dcnn_40.h5")
# y_pred = []
...
# plt.savefig('{}_{}.png'.format('3dcnn', 'roc'), dpi=500)
# plt.show()